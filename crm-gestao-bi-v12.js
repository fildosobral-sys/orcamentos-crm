...
function paintIntelligence(){
  ...
  <div class="fs-v12-funnel-note"><strong>Leitura gerencial:</strong><span>Pesquisas de orçamento → Em aberto → Agendados → Concluídos → Perdidos.</span><span>Em aberto = posição atual da carteira.</span></div>
