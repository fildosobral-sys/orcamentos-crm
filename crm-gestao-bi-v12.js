...
function paintIntelligence(){
  ...
  <div class="fs-v12-grid">
    ...
    <article class="fs-v12-panel evolution"><div class="fs-v12-panel-head"><i>📈</i><div><strong>Evolução comercial</strong><small>Valor concluído e número de vendas · ${g}</small></div></div><div class="fs-v12-evo-summary"><span><strong>${money(m.value)}</strong><small>Vendido no período</small></span><span><strong>${m.wins}</strong><small>Vendas concluídas</small></span><span><strong>${createdRecords().length}</strong><small>Pesquisas</small></span><span><strong>${pct(m.conversion)}</strong><small>Taxa de conversão</small></span></div><div class="fs-v12-chart">${chart(e)}</div></article>
